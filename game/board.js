...
export class Board {
   ...
   */
  constructor(width = 30, height = 15, mines = 20, reRenderCallback) {
    this.width = width
    this.height = height
    this.mines = mines
    this.lost = false
    ...
    this.reRenderCallback = reRenderCallback ? reRenderCallback.bind(this) : null;
  }
  ...
  endIt(status) {
    ...
    console.log('I LOSE....');
    this.clearAll();
    this.reRenderCallback('lose');
  }

  //wanted to add a new neighbor checking where it evaluate base on ids relationship
  /*
      (x-10)-1   x-10   (x-10)+1
        x-1      x      x+1
      (x+10)-1   x+10   (x+10)+1
